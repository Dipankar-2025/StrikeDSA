class Solution {
  public:
    string findOrder(vector<string>& words) {
        ...
        // Total number of unique character mere pass kitne hai, make there indedree 0
        for(auto word: words){
            for(char c: word){
                InDegree[c] = 0;
            }
        ...
        queue<char>q;
        // kahn's algorith, lush alll the charater in queue whose indegree is zero
        ...
        //    look at all the neibour of the node
